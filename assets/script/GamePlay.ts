...
export default class NewClass extends cc.Component {
    ...
    reloadBtnEvent() {
        if (this.checkShoot == 0) {
            ...
            this.reloadBtnGun2.node.on(cc.Node.EventType.TOUCH_MOVE, this.checkReloadFun, this);
            this.reloadBtnGun2.node.on(cc.Node.EventType.TOUCH_END, this.endReloadEvent, this);
        }
    ...
    modeBtnEvent() {
        if (this.checkShoot == 0) {
            ...
            this.modeBtnGun2.node.on(cc.Node.EventType.TOUCH_MOVE, this.checkModeFun, this);
            this.modeBtnGun2.node.on(cc.Node.EventType.TOUCH_END, this.endModeEvent, this);
        }
    }
    lockBtnEvent() {
        if (this.checkShoot == 0) {
            ...
            this.lockBtnGun2.node.on(cc.Node.EventType.TOUCH_MOVE, this.checkLockFun, this);
            this.lockBtnGun2.node.on(cc.Node.EventType.TOUCH_END, this.endLockEvent, this);
        }
    ...
    endReloadEvent() {
        if (this.checkTouch) {
            ...
            if (this.checkShoot == 0) {
                ...
                this.reloadBtnGun2.node.off(cc.Node.EventType.TOUCH_MOVE);
                this.reloadBtnGun2.node.off(cc.Node.EventType.TOUCH_END);
            }
    ...
    endModeEvent(event) {
        if (this.checkTouch) {
            ...
            if (this.checkShoot == 0) {
                ...
                this.modeBtnGun2.node.off(cc.Node.EventType.TOUCH_MOVE);
                this.modeBtnGun2.node.off(cc.Node.EventType.TOUCH_END);
            }
            this.openLock();
    ...
    endLockEvent(event) {
        if (this.checkTouch) {
            ...
            if (this.checkShoot == 0) {
                ...
                this.lockBtnGun2.node.off(cc.Node.EventType.TOUCH_MOVE);
                this.lockBtnGun2.node.off(cc.Node.EventType.TOUCH_END);
            }
            this.openLock2();
        }
    }
    ...
    reloadBullet() {
        ...
        if (this.checkShoot == 0) {
            ...
            this.bulletNum = 5;
            cc.tween(this.bangDan).to(0.25, { y: -160 }).call(() => {
                this.bulletNumLabel.string = `${this.bulletNum}/30`;
                cc.audioEngine.play(this.reloadSound, false, 1);
            }).start();
            cc.tween(this.gun).delay(0.26).to(0.15, { angle: 3 }).to(0.15, { angle: 0 }).start();
            ...
            this.bulletNum = 20;
            cc.tween(this.bangDan2).to(0.25, { y: -45 }).call(() => {
    ...
    openLock2() {
        ...
        if (this.checkShoot == 0) {
            ...
            cc.tween(this.khoaNong).to(0.1, { x: 83 }).to(0.1, { x: 173 }).call(() => {
                this.shootBtn.node.active = true;
                this.hand.active = true;
                this.hand.getComponent(cc.Animation).play('hand');
                this.hand.setPosition(cc.v3(-50, -100));
            }).start();
        }
        else {
            this.hand.active = false;
            ...
            if (this.bulletNum > 0) {
                cc.tween(this.gun)
                    .call(() => {
                        ...
                        cc.tween(this.co).to(0.05, { angle: -25 }).to(0.05, { angle: 0 }).start();
                    })
                    .to(0.05, { x: -20, angle: 1 }).call(() => {
                        cc.audioEngine.play(this.gunFire, false, 1);
                        this.addShootEffect(this.gun, cc.v3(254, 70));
                        this.shootBullet(cc.v3(274, 70));
